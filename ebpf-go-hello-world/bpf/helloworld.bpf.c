...
char LICENSE[] SEC("license") = "Dual BSD/GPL"; //If you don't provide a license section, the loader may reject a program that requires GPL-compatible licensing.
...
/*
    A ring buffer (BPF_MAP_TYPE_RINGBUF) is a way for kernel eBPF programs to send data to userspace
    .maps
     └── events
...
} events SEC(".maps"); // Tells Clang to put this map definition into the ELF .maps section.
